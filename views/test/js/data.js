...
window.myPie = new Chart(ctx, config);
    $('.viewDetails').click(function(){
      $('#admin').removeClass();
      $('#admin').addClass('col s12 m8 l8');
      $('#pieChart').fadeIn(800);
      var score = $(this).find('#score').val();
      var wrong = $(this).find('#wrong').val();
      var testTitle = $(this).find('#testId').val();
      $('#itemCount').html('Item Count: '+$(this).find('#totalItems').val());
      $('#itemCount').show();
      $('#itemGrade').html('Grade: '+$(this).find('#grade').val());
      $('#itemGrade').show();
      config.data.datasets[0].data = [parseInt(wrong), parseInt(score)];
      config.options.title.text = testTitle;
      window.myPie.update();
    });

    $('#closeChart').click(function(){
      $('#pieChart').fadeOut(800);
      $('#admin').removeClass();
      $('#admin').addClass('col s12 m8 l8 offset-m2 offset-l2');
    });
